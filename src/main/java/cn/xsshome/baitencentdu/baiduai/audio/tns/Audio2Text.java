...
import cn.xsshome.baitencentdu.baiduai.util.RandomStringGenerator;
...
//		String path2 = "C:/Users/Administrator/Desktop/16k.pcm";
//		System.out.println(Base64Util.encode(FileUtil.readFileByBytes(path2)));
//	}
	public static void main(String[] args) throws Exception {
		//合成的MP3语音文件
//		String path = "G:/222.wav";
//		MP3转pcm要保存的路径和文件名
		String path2 = "C:/Users/Administrator/Desktop/16k.pcm";
//		String path2 = "C:/Users/Administrator/Documents/Tencent Files/783021975/FileRecv/test.pcm";
//		String path2 = "C:/Users/Administrator/Desktop/1517236052046.pcm";
//		MP3ConvertPCM.mp3Convertpcm(path, path2);
//		WAVConvertPCM.convertAudioFiles(path, path2);
		// 对语音二进制数据进行识别   
	    byte[] data = FileUtil.readFileByBytes(path2);    //readFileByBytes仅为获取二进制数据示例
	    String speech = Base64Util.encode(data);
	    File file = new File(path2);
	    long len = file.length();
	    String result = Audio2text("pcm", 16000,RandomStringGenerator.getRandomStringByLength(60),"24.70e2551236e04b80a8135ed96e3aecbb.2592000.1519957100.282335-9695383", speech, len);
